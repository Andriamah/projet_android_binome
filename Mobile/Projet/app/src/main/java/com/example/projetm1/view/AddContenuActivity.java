...
public class AddContenuActivity extends AppCompatActivity {
    ...
    /*
     * A PARTIR D ICI LES CODES SERONT RESERVES A ETRE DANS ACTIVITY OU SE TROUVE LE DETAIL DU CONTENU*/
        ...
        notificationController.addNotification(id,id_client, id_contenu,formattedDate, new NotificationController.AddNotificationCallBack() {
            ...
            public void onAddNotificationSuccess() {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(AddContenuActivity.this, "Connexion réussie", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onAddNotificationFailure(String errorMessage) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(AddContenuActivity.this, "Erreur de connexion : " + errorMessage, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
